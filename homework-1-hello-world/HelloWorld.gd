class_name HelloWorld extends Control
...
func _ready():
	...
	- Remember: indentation matters! The first letter
		of your line of code should be lined up with the
	...
	"""
	Part C:
		-One more time, write your code in the
